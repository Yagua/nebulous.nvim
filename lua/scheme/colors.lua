...
if vim.g.nb_style  == "midnight" then
  --Light colors
  Colors.background  = "#201F30"
  Colors.Red         = "#F94B7D"
  Colors.Blue        = "#00D5A7"
  Colors.Green       = "#B8EE92"
  Colors.Purple      = "#C46AF5"
  Colors.Yellow      = "#FFB046"
  Colors.Orange      = "#E796FF"
  Colors.Violet      = "#FA98FA"
  Colors.Magenta     = "#18ABDA"
  Colors.Pink        = "#56D6D6"
  Colors.White       = "#CED5E5"
  Colors.Cyan        = "#5CDFDF"
  Colors.Aqua        = "#FAD726"
  Colors.Black       = "#232237"
  Colors.Grey        = "#404554"
  Colors.Grey_2      = "#282736"
  Colors.Grey_3      = "#424D55"
  Colors.Custom_1    = "#3C3C4B"
  Colors.Custom_2    = "#AFFDF1"
  Colors.Custom_3    = "#E2E7E6"

  --Dark colors
  Colors.DarkRed     = "#FD2E6A"
  Colors.DarkOrange  = "#FB9631"
  Colors.DarkBlue    = "#007ED3"
  Colors.DarkGreen   = "#61D143"
  Colors.DarkYellow  = "#19CBCC"
  Colors.DarkMagenta = "#FE92E1"
  Colors.DarkCyan    = "#FFAE2D"
  Colors.DarkGrey    = "#615E5E"
  Colors.DarkGrey_2  = "#878D8D"
