...
function setup.load_plugins()
  ...
  local syntax = {
    ...
    LspReferenceText =                     { fg = scheme.none,        bg = scheme.Custom_1, scheme.none },
    LspReferenceRead =                     { fg = scheme.none,        bg = scheme.Custom_1, scheme.none },
    LspReferenceWrite =                    { fg = scheme.none,        bg = scheme.Custom_1, scheme.none },
