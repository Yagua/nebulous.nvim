...
function setup.load_colors(scheme)
  ...
  local editor = {
    ...
    xmlDocTypeDecl =     { fg = scheme.White,  bg = scheme.none, scheme.none },
    xmlDocTypeKeyword =  { fg = scheme.Purple, bg = scheme.none, scheme.none },
    xmlCdataStart =      { fg = scheme.White,  bg = scheme.none, scheme.none },
    xmlCdataCdata =      { fg = scheme.Purple, bg = scheme.none, scheme.none },
    xmlProcessingDelim = { fg = scheme.White,  bg = scheme.none, scheme.none },
    xmlAttribPunct =     { fg = scheme.White,  bg = scheme.none, scheme.none },
