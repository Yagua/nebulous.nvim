...
Group.new('Normal',           c.White,        c.background,   no)
...
Group.new('cssBraces',            c.DarkGrey,  c.none, no)
...
Group.new('javaScriptParens',               c.Grey_3,     c.none,       no)
...
Group.new('csParens',                 c.Grey,  c.none, no)
